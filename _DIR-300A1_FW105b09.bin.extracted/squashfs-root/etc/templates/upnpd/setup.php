...
set($dev_root."/devicetype",	"urn:schemas-upnp-org:device:InternetGatewayDevice:1"); anchor($dev_root);
...
set($serv_root."/servicetype",	"urn:schemas-microsoft-com:service:OSInfo:1"); anchor($serv_root);
