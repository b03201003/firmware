...
/* ---------------------------------------------------------------------- */
$m_title_wizard	= "Internet Connection Setup wizard";
$m_desc_wizard =
	"If you would like to utilize our easy to use Web-based Wizard to assist you ".
	"in connecting your new D-Link Systems Router to the Internet, click on the button below.";
$m_note_wizard =
...
$m_title_manual	= "Manual internet connection options";
$m_desc_manual =
	"If you would like to configure the Internet settings of your new ".
	"D-Link Router manually, then click on the button below.";

$m_setup_wiz	= "Internet Connection Setup Wizard";
$m_manual_cfg	= "Manual Internet Connection Setup";
