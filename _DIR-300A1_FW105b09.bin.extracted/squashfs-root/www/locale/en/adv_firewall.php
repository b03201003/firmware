...
$a_confirm_to_del_fw= "Are you sure to DELETE this rule?";
$a_invalid_port="Invaild Port !";
$a_invalid_port_range="Invaild Port Range !";

$a_invalid_src_startip="Invalid Source Start IP Address !";
$a_src_startip_in_different_subnet   = "Invalid source start IP address ! The source start IP address and router address should be in the same network.";

$a_invalid_src_endip="Invalid Source End IP Address !";
$a_src_endip_in_different_subnet   = "Invalid source end IP address ! The source end IP address and router address should be in the same network.";

$a_invalid_dst_startip="Invalid Destination Start IP Address !";
$a_dst_startip_in_different_subnet   = "Invalid destination start IP address ! The destination start IP address and router address should be in the same network.";

$a_invalid_dst_endip="Invalid Destination End IP Address !";
$a_dst_endip_in_different_subnet   = "Invalid destination end IP address ! The destination end IP address and router address should be in the same network.";
