...
<tr>
	<td height=40>
		...
		<p>
			...
			click the Manual Internet Connection Setup.
		</p>
	</td>
</tr>
<tr>
...
<tr>
	<td height=46>
		<p>
			...
			Enable &quot;Access Point Mode&quot; will make the device to function like an wireless AP.
			All the NAT functions will be disabled except settings related to wireless.<br>
...
<tr>
	<td height=142>
		<p>
			...
			IP address automatically. Cable modem providers typically use dynamic assignment of IP Address.
		</p>
		<p>
...
<tr>
	<td height=47>
		...
		<p>
			...
			Ethernet Card installed in the computer used to configure the device. It is only necessary to fill in
			the field if required by your ISP.<br>
			<strong><em>Primary DNS Address </em></strong> -
			...
			The amount of time of inactivity before the device will disconnect your PPPoE session.
			...
			then the connection will be dropped. This option only applies to the Connect-on-demand Connect mode.<br>
			<strong><em>MTU </em></strong> -
			MTU (Maximum Transmission/Transfer Unit) is the largest packet size that can be sent over a network.
...
<tr>
	<td height=20>
		...
		<p>
			...
			If the connection is inactive for longer than the defined Maximum Idle Time, then the connection will be dropped.
			This option only applies to the Connect-on-demand Connect mode.<br>
			<strong><em>MTU </em></strong> -
...
<tr>
	<td height=20>
		...
		<p>
			...
			<strong><em>Maximum Idle time </em></strong> -
			The amount of time of inactivity before the device will disconnect your L2TP session. Enter a Maximum Idle Time (in minutes)
			...
			Connect-on-demand Connect mode.<br>
			<strong><em>MTU</em></strong> -
...
<tr>
	<td height=20>
		<p>
			...
			To configure a Russia PPTP Internet connection, configure as previously described for PPTP connections.
			If any static route needs to be setup by your ISP, please refer to the &quot;Routing&quot; function in 
			&quot;ADVANED&quot; menu for further setup.
...
<tr>
	<td height=20>
		<p>
			...
			To configure a Russia PPPoE Internet connection, configure as previously described for PPPoE 
			connections and add the physical WAN IP settings as instructed from the ISP.
			If any static route needs to be setup by your ISP, please refer to the &quot;Routing&quot; function 
			in &quot;ADVANED&quot; menu for further setup.
		</p>
	</td>
</tr>
<tr><td height=20>&nbsp;</td></tr>
...
<tr>
	<td height=20>
		<p>
			...
			This feature provides users a more intuitive way of setting up wireless security. It comes in with two
			formats: PIN number and push button. Entering the PIN number that comes with the device in the wireless
			card utility or Windows Vista's wireless cient utility if the wireless card has a certified Windows Vista
			driver can automatically set up wireless security between the router and the client. The wireless card
			will have to support Wi-Fi Protected Setup in either format in order to take advantage of such feature.
		</p>
	</td>
</tr>
<tr><td height=20>&nbsp;</td></tr>
...
<tr>
	<td height=20>
		<p>
			...
			WEP and is based on a key that changes automatically at a regular interval.
		</p>
		<p>
			<strong><em>Cipher Type</em></strong> -
			The <?query("/sys/modelname");?> support two different cipher types when WPA is used as the Security Type.
			...
			This means of WPA authentication is used in conjunction with a RADIUS server that must be present on your network. Enter
			the IP address, port, and Shared Secret that you RADIUS is configured for. You also have the option to enter information
			for a second RADIUS server in the even that there are two on your network which you are using to authenticate wireless clients.
		</p>
	</td>
</tr>
<tr><td height=20>&nbsp;</td></tr>
<tr>
	<td height=20>
		...
		<p>
			<strong><em>Cipher Type</em></strong> -
			The <?query("/sys/modelname");?> support two different cipher types when WPA is used as the Security Type. These two
			...
			other wireless devices you are trying to add to your network.<br>
			<strong><em>802.1X</em></strong> -
			This means of WPA2 authentication is used in conjunction with a RADIUS server that must be present on your network.
			Enter the IP address, port, and Shared Secret that you RADIUS is configured for. You also have the option to enter
...
<tr>
	<td height=20>
		<p>
			...
			When DNS relay is disabled, all DHCP clients of the router will be assigned the ISP DNS server.
		</p>
	</td>
</tr>
<tr><td height=20>&nbsp;</td></tr>
<tr>
	<td height=20>
		...
		<p>
			...
			the PC that you desire to have the router to statically assign the same IP to or choose the PC from
