...
<tr>
	<td height=228>
		<p>
			<a name=05><strong>Advanced Port Forwarding </strong></a><br>
			...
			you define a public port on your router for redirection to an internel LAN IP Address and LAN port.
		</p>
		<p>
			Advanced Port Forwarding Parameters<br>
			<strong><em>Name</em></strong> -
			Assign a meaningful name to the virtal server, for example Web Server. Several well-known types of virtual
			...
			A list of pre-defined popular applications that users can choose from for faster configuratoin.<br>
...
echo "		<strong><em>Subnet Mask </em></strong> - One bits in the mask specify which bits\n";
