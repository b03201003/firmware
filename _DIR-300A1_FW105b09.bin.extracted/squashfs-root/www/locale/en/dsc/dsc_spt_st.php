...
This page displays the current information for the <?query("/sys/modelname");?>. The page will show the version of the firmware currently loaded in the device. <br>
...
<strong><em>WAN (Wide Area Network) - </em></strong>This displays the MAC Address of the WAN interface, as well as the IP Address, Subnet Mask, Default Gateway, and DNS server information that the <?query("/sys/modelname");?> has obtained from your ISP. It will also display the connection type (Dynamic, Static, or PPPoE) that is used establish a connection with your ISP. If the router is configured for Dynamic, then there will be buttons for releasing and renewing the IP Address assigned to the WAN interface. If the router is configured for PPPoE, there will be buttons for connecting and disconnecting the PPPoE session.<br> 
<strong><em>
Wireless 802.11
