...
<tr>
	<td height=40>
		...
		save settings for the unit. Make sure to save your system settings before doing a factory restore.<br>
		<strong><em>Save</em></strong> - Click this button to save the configuration file from the router.<br>
		<strong><em>Browse</em></strong> -
		Click Browse to locate a saved configuration file and then click to Load to apply these
...
<tr>
	<td height=51>
		...
		before doing a firmware upgrade. Please check the D-Link <a href=<?query("/sys/supporturl");?>>support site</a>
		for firmware updates or you can click on <strong>Check Now</strong> button to have the router check the
...
<tr>
	<td height="197">
		<p>
			...
			It is an advanced feature that integrates a LAN cable tester on every Ethernet port on the router.
			Through the graphical user interface (GUI), Cable Test can be used to remotely diagnose and report
			cable faults such as opens, shorts, swaps, and impedance mismatch. This feature significantly reduces
