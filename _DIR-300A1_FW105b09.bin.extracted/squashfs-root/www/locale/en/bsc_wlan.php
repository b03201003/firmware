...
$a_invalid_wep_64_wep_key	= "The Key is invalid. The Key must be 5 characters or 10 hexadecimal number.";
$a_invalid_wep_128_ascii_wep_key= "The Key is invalid. The Key must be 13 characters.";
$a_invalid_wep_128_hex_wep_key	= "The Key is invalid. The Key must be 26 hexadecimal number.";
$a_invalid_wep_64_ascii_wep_key	= "The Key is invalid. The Key must be 5 characters.";
$a_invalid_wep_64_hex_wep_key	= "The Key is invalid. The Key must be 10 hexadecimal number.";
...
$a_invalid_passphrase_len	= "The length of Passphrase should be 8~63.";
