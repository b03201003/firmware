...
<!-- ________________________________ Main Content Start ______________________________ -->
		...
		<tr>
			...
			<td class="l_tb">
				<input type=password id=password name=password size=30 maxlength=255 value="<?=$G_DEF_PASSWORD?>">
			</td>
		</tr>
		<tr>
			<td class="r_tb"><strong><?=$m_verify_pwd?> :</strong></td>
			<td class="l_tb">
				<input type=password id=password_v name=password_v size=30 maxlength=255 value="<?=$G_DEF_PASSWORD?>">
			</td>
		</tr>
		<tr>
