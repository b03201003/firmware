...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
			...
			<form id="form1" name="form1" method="post" action="adv_access_add.cgi">
		  ...
		  <P>This wizard will guide you through the following steps to add a new policy for Access Control.</P>
		    <table width="525" class=formarea>
              <tbody>
              <tr>
                <td width="516">Step 1 - Choose a unique name for your policy</td></tr>
              <tr>
                <td>Step 2 - Select a schedule</td></tr>
              <tr>
                <td>Step 3 - Select the machine to which this policy 
              applies</td></tr>
              <tr>
                <td>Step 4 - Select filtering method</td></tr>
              <tr>
                <td>Step 5 - Select filters</td></tr>
              <tr>
                <td>Step 6 - Configure Web Access 
            Logging</td></tr></tbody></table><hr>
            <table width="362" align="center">
              <td> <div align="center"> 
					<input name="perv" type="button" id="perv" value="Perv" disabled>
					&nbsp; 
