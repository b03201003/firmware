...
function onPageLoad(){
var sel_wan_l2tp_dynamic ="<% CmoGetCfg("wan_l2tp_dynamic","none"); %>";
	var p_wan_l2tp_dynamic = get_by_name("wan_l2tp_dynamic");
	if(sel_wan_l2tp_dynamic == "1"){
		p_wan_l2tp_dynamic[0].checked = true;
	}else{
		p_wan_l2tp_dynamic[1].checked = true;
	}
		
		
	var sel_wan_l2tp_connect_mode ="<% CmoGetCfg("wan_l2tp_connect_mode","none"); %>";
	var p_wan_l2tp_connect_mode = get_by_name("wan_l2tp_connect_mode");
	if(sel_wan_l2tp_connect_mode == "always_on"){
		p_wan_l2tp_connect_mode[0].checked = true;
	}else if(sel_wan_l2tp_connect_mode == "manual"){
		p_wan_l2tp_connect_mode[1].checked = true;
	}else{
		p_wan_l2tp_connect_mode[2].checked = true;
	}	
...
function disable_l2tp_ip(){
	...
	function send_l2tp_request(){
    	...
    	var idle = get_by_id("wan_l2tp_max_idle_time");	    	
    	...
    	if(server_ip == ""){
       	...
       	if (!check_pwd("wan_l2tp_password", "l2tppwd2")){
       		return false;
       	}
...
<input type="hidden" name="html_response_return_page" value="wan_l2tp.asp">
...
<div id=maincontent>
              ...
              <div id=box_header>
            	...
            	<input name="button2" type=reset class=button_submit value="Don't Save Settings"  onClick="window.location.href='wan_l2tp.asp'">
              </div>
              <div class=box>
                ...
                <table cellSpacing=1 cellPadding=1 width=525 border=0>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><font size=2>&nbsp;
                      <input type=text id="wan_l2tp_ipaddr" name="wan_l2tp_ipaddr" size=16 maxlength=15 value="<% CmoGetCfg("wan_l2tp_ipaddr","none"); %>">
                      </font></td>
                    </tr>
                    <tr>
                      <td width=150 class="form_label">Subnet Mask :</td>
                      <td><font size=2>&nbsp;
                      <input type=text id="wan_l2tp_netmask" name="wan_l2tp_netmask" size=16 maxlength=15 value="<% CmoGetCfg("wan_l2tp_netmask","none"); %>">
                      </font></td>
                    </tr>
                    <tr>
                      <td width=150 class="form_label">Gateway :</td>
                      <td><font size=2>&nbsp;
                      <input name="wan_l2tp_gateway" type=text id="wan_l2tp_gateway" size=16 maxlength=15 value="<% CmoGetCfg("wan_l2tp_gateway","none"); %>">
                      </font></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><font size=2>&nbsp;
                      <input type=text id="wan_l2tp_server_ip" name="wan_l2tp_server_ip" size=32 maxlength=32 value="<% CmoGetCfg("wan_l2tp_server_ip","none"); %>">
                      </font></td>
                    </tr>
                    <tr>
                      <td width=150 class="form_label">L2TP Account :</td>
                      <td><font size=2>&nbsp;
                      <input type=text id="wan_l2tp_username" name="wan_l2tp_username" size=32 maxlength=63 value="<% CmoGetCfg("wan_l2tp_username","none"); %>">
                      </font></td>
                    </tr>
                    <tr>
                      <td width=150 class="form_label">L2TP Password :</td>
                      <td><font size=2>&nbsp;
                      <input type=password id="wan_l2tp_password" name="wan_l2tp_password" size=32 maxlength=31 value="WDB8WvbXdHtZyM8Ms2RENgHlacJghQyG">
                      </font></td>
                    </tr>
                    <tr>
                      <td width=150 class="form_label">L2TP Retype password :</td>
                      <td><font size=2>&nbsp;
                      <input type=password id=l2tppwd2 name=l2tppwd2 size=32 maxlength=31 value="WDB8WvbXdHtZyM8Ms2RENgHlacJghQyG">
                      </font></td>
                    </tr>
                    <tr>
                      <td width=150 class="form_label">Maximum Idle Time :</td>
                      <td><font size=2>&nbsp;
                      <input type=text id="wan_l2tp_max_idle_time" name="wan_l2tp_max_idle_time" maxlength=4 size=5 value="<% CmoGetCfg("wan_l2tp_max_idle_time","none"); %>">
    Minutes</font></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><font size=2>&nbsp;
                      <input type=radio name="wan_l2tp_connect_mode" value="always_on">
    Always-on
    <input type=radio name="wan_l2tp_connect_mode" value="manual">
    Manual
    <input type=radio name="wan_l2tp_connect_mode" value="on_demand">
