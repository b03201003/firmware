        ...
        <table border=0 width=450 height=175 cellpadding=0>
          <tr> 
            <td width="11%" height="76"> 
              <div align="left"><b><font face="Arial" size="2">LAN2</font></b></div>
            </td>
            ...
            <td width="35%" height="76"> 
			  ...
			  <input type="hidden" id="lan_port_speed_duplex_01" name="lan_port_speed_duplex_01" value="<%  CmoGetStatus("lan_port_speed_duplex_01"); %>">
                ...
                <!-- insert name=link_stat_txt_lan2 -->
                </div>
            </td>
          </tr>
          <tr> 
            ...
            <td height=20>
              <div align="center">
                <font face="Tahoma" size="2"><strong><!-- insert name=lan2_tx --></strong></font>
                </div>
            </td>
            <td height=20>&nbsp;</td>
          </tr>
          <tr> 
            ...
            <td height=20>
              <div align="center">
                <font face="Tahoma" size="2"><strong><!-- insert name=lan2_rx --></strong></font>
               </div>
            </td>
            <td height=20>&nbsp;</td>
          </tr>
