...
<script language="JavaScript">
	...
	function onPageLoad(){
		for (var i = 0; i < 20; i++){
			...
			if(temp_vs ==""){
				if (i > 9){
					 get_by_id("vs_rule_" + i).value = "0//TCP/0/0/0.0.0.0/Always";
				}else{
					get_by_id("vs_rule_0" + i).value = "0//TCP/0/0/0.0.0.0/Always";				
				}
			}
	...
	function check_port_conflict(){
		for (var i = 1; i <= 20; i++){
			for (var j = i+1; j <= 20; j++){
				if( get_by_id("public_port" + i).value !=0 && get_by_id("public_port" + i).value !="" && get_by_id("public_port" + j).value !=0 && get_by_id("public_port" + j).value !=""){
					if(get_by_id("public_port" + i).value == get_by_id("public_port" + j).value){
						if(get_by_id("enable" + i).checked == true && get_by_id("enable" + j).checked == true){
							alert("Public port conflict.");
							return false;
						}
					}
				}
	...
	function set_virtual_server(){
		for (var i = 0; i < 20; i++){
			...
			if (temp_vs.length > 1){
				...
				get_by_id("name" + (i+1)).value = temp_vs[1];
				set_protocol(temp_vs[2], get_by_id("protocol" + (i+1)));	
				get_by_id("public_port" + (i+1)).value = temp_vs[3];
				get_by_id("private_port" + (i+1)).value = temp_vs[4];
				get_by_id("ip" + (i+1)).value = temp_vs[5];
				set_selectIndex(temp_vs[6], get_by_id("schedule" + (i+1)));
	...
	function send_request(){
		...
		for (var i = 1; i <= 20; i++){		
			...
			if (i > 10){
				get_by_id("vs_rule_" + (i-1)).value = "";
			}else{
				get_by_id("vs_rule_0" + (i-1)).value = "";
			}
			...
			if (get_by_id("name" + i).value != ""){
				...
				if (!check_port(get_by_id("public_port" + i).value)){
		            alert(msg[PUBLIC_PORT_ERROR]);
		            return false;
		        }

				if (!check_port(get_by_id("private_port" + i).value)){
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
			<td id="sidenav_container" valign="top" width="125" align="right">
                    ...
                    <tr>
                      <td id=sidenav_container>
                        <div id=sidenav>
                          <UL>
							<LI>
                              <div id=sidenavoff>Virtual Server</a></div>
                            <LI>
				...
				<input type="hidden" name="html_response_return_page" value="adv_virtual.asp">
			...
			<td valign="top" id="maincontent_container">
				<div id=maincontent>
                  <div id=box_header>
                    <h1>Virtual server Rules : </h1>
                   	<p>The Virtual Server option allows you to define a single public port on your router for redirection to an internal LAN IP Address and Private LAN port if required. This feature is useful for hosting online services such as FTP or Web Servers.</p>
                    <input name="button" id="button" type="submit" class=button_submit value="Save Settings" onClick="return send_request()">
                    <input name="button2" type=button class=button_submit value="Don't Save Settings"  onClick="window.location.href='adv_virtual.asp'">
                  </div>
                  <div class=box>
                    <h2>20 - virtual server Rules</h2>
                    <table borderColor=#ffffff cellSpacing=1 cellPadding=2 width=525 bgColor=#dfdfdf border=1>
                      <tbody>
                        <tr>
                          ...
                          <td width="47" align=middle>Port</td>
                          <td width="56" align=middle>Traffic Type</td>
                          <td width="96" align=middle>Schedule</td>
                        </tr>
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Private
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port2" name="public_port2" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port3" name="public_port3" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port4" name="public_port4" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port5" name="public_port5" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port6" name="public_port6" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port7" name="public_port7" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port8" name="public_port8" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port9" name="public_port9" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port10" name="public_port10" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port11" name="public_port11" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port12" name="public_port12" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port13" name="public_port13" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port14" name="public_port14" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port15" name="public_port15" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port16" name="public_port16" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port17" name="public_port17" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port18" name="public_port18" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port19" name="public_port19" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
                        ...
                        <tr>
                          ...
                          <td align=middle valign="bottom">Public
                            <input type="text" id="public_port20" name="public_port20" size=5 maxlength="5"></td>
                          	<td align=middle rowspan="2">
      ...
      cellPadding=2 bgColor=#ffffff borderColorLight=#ffffff border=0>
                  <tbody>
                    <tr>
                      <td id=help_text><b>Helpful Hints..</b></p>
                        <p class="style1"> Check the<strong> Application Name</strong> drop down menu for a list of pre-defined applications that you can select from.  If you select one of the pre-defined applications, click the arrow button next to the drop down menu to fill out the appropriate fields.</p>                        
                        ...
                        <p class="style1">In order to apply a schedule to a Virtual Server Rule, you must first define a schedule on the <strong>Tools>Schedules</strong> page. </p></td>
                    </tr>
                  </tbody>
                </table></td>
		</tr>
