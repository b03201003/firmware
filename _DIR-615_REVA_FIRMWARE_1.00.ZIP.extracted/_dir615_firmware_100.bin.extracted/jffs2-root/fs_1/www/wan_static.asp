...
function send_static_request(){
		...
		//get_by_id("mac_clone_addr").value= "";
...
<input type="hidden" name="html_response_return_page" value="wan_static.asp">
...
<div id=maincontent>
              ...
              <div id=box_header>
				...
				<input name="button" type="submit" class=button_submit value="Save Settings" onClick="return send_static_request()">
            	<input name="button2" type=reset class=button_submit value="Don't Save Settings"  onClick="window.location.href='wan_static.asp'">
              </div>
              <div class=box>
              ...
              <div class=box id=show_static>
                ...
                <p class="box_msg">Enter the static address information provided by your Internet Service Provider (ISP).</p>

                <table cellSpacing=1 cellPadding=1 width=525 border=0>
                  <tr>
                    <td width=150 class="form_label">IP Address : </td>
                    <td><font size=2>&nbsp;
                    <input type=text id="wan_static_ipaddr" name="wan_static_ipaddr" size=16 maxlength=15 value="<% CmoGetCfg("wan_static_ipaddr","none"); %>">
    (assigned by your ISP)</font></td>
                  </tr>
                  <tr>
                    <td width=150 valign=top class="form_label">Subnet Mask :</td>
                    <td><font size=2>&nbsp;
                    <input type=text id="wan_static_netmask" name="wan_static_netmask" size=16 maxlength=15 value="<% CmoGetCfg("wan_static_netmask","none"); %>">
                    </font></td>
                  </tr>
                  <tr>
                    <td width=150 class="form_label">ISP Gateway Address :</td>
                    <td><font size=2>&nbsp;
                    <input type=text id="wan_static_gateway" name="wan_static_gateway" size=16 maxlength=15 value="<% CmoGetCfg("wan_static_gateway","none"); %>">
                    </font></td>
                  </tr>
                  <tr>
    ...
    &nbsp;&nbsp;<input type="button" value="Clone MAC Address" name="clone" onClick="clone_mac_action()">
                  ...
                  <tr>
                    <td width=150 class="form_label">Secondary DNS Address :</td>
                    <td><font size=2>&nbsp;
...
<form id="form2" name="form2" method="post" action="mac_clone.cgi"><input type="hidden" name="html_response_page" value="wan_static.asp"><input type="hidden" name="html_response_return_page" value="wan_static.asp"></form>
           </td>
